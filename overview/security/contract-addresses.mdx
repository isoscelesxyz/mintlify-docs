...
This reference page lists all verified smart contract addresses for Aerodrome Finance on Base. Use these addresses when integrating with Aerodrome or verifying transactions.
...
<CardGroup cols={2}>
  <Card title="Security Overview" icon="shield" href="/overview/security/overview">
    Learn about audits and emergency governance
  </Card>
  <Card title="Developer Resources" icon="code" href="/development/sugar">
    Integrate with Aerodrome using Sugar API
  </Card>
</CardGroup>
